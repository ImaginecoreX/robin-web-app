    ...
    return (
        <div className='w-full h-auto flex justify-center items-center mt-10 mb-10'>
            <div className='flex justify-center items-center'>
                <button onClick={openModal} className='text-white'>Edit</button>
            </div>
                ...
                <div className='w-full h-auto box-border px-5'>
                    ...
                    <div className='flex flex-col justify-center mb-5'>
                        <div className="border-b border-gray-900/10 pb-12">
                            <h2 className="text-base font-semibold leading-7 text-gray-900 mt-2">Edit Category Information</h2>
                            <p className="mt-1 text-sm leading-6 text-gray-600">Edit category informations and save to edit details.</p>
